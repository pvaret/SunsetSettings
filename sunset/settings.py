...
class Settings(Bundle):
    ...
    :meth:`setName()` method on the new section after creation.
    ...
    def setName(self, name: str) -> str:
        ...
        if name:
            i = 0
            while any(section.name() == name for section in self.siblings()):
                i += 1
